...
| Preview          | `300.000.000`       | `8192`             | `2288.8`         | `14.000`    | `200`       |
...
Так как таблица `Announcement` достаточно большая и требует множество индексов потребуется использовать шардинг.
