...
- **PostgreSQL:**
    - Объем данных ~1 ТБ, чтение 1680 RPS, Запись 40 RPS Трафик < 20 Mbit/s
- **Nginx**:
...
|-----------------------|---------------------------------------|-------|
| Tarantool             | 2x6338 (32) / 16x96GB / 4x NVMe 8 GB  | 2     |
| ClickHouse            | 2x6338 (32) / 4x8GB / 12x NVMe 2 TB   | 1     |
| Elasticsearch - поиск | 2x6338 (16) / 4x8GB / 4x NVMe 8 GB    | 1     |
| CEPH                  | 2x6338 (64) / 8x32GB / 24x NVMe 12 TB | 1     |
| PostgreSQL            | 2x6338 (32) / 8x32GB / 2x NVMe 1 TB   | 1     |
| LanceDB               | 2x6238 (16) / 4x2GB / 2x NVMe 512 GB  | 1     |
